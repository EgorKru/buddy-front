...
export default function SearchBar({
    ...
    return (
      <div className={styles.searchResultsDropdown}>
        <div className={styles.searchResultsInfo}>
          <span className={styles.searchResultsEmpty}>Ничего не найдено</span>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className={styles.searchResultsDropdown}>
      <div className={styles.searchResultsInfo}>
        <span className={styles.searchResultsCount}>{searchResults.length} найдено</span>
      </div>
          ...
          return (
            <div key={msg.id} className={styles.searchResultItem}>
              ...
              >
                ...
                <div className={styles.searchResultTime}>{formatChatTime(msg.createdAt)}</div>
              </div>
              <button
